# R code implementation solving the intersection between a line and a plane in 3D
# source http://paulbourke.net/geometry/pointlineplane/intersectionLinePlane.R
# Downloaded 17.4.27
